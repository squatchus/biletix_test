...
Помимо указанных в задании параметров метода API GetOptimalFares(), используются также ключ "direct_only", т.к. сложные рейсы с пересадками требует иного формата отображения, нежели тот, что предложен для реализации в задании.
